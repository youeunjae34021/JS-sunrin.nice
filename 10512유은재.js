...
class ScoreTable
{
    ...
    drawTable()
    {
        document.write(this.studentList[0].id + " " + this.student1[0].name);
        for(let i= 0; i<this.studentList[0].score.length;i++)
        {
            document.write(this.studentList[0].score[1]);
        }
    }
...
let student1 = new Student(10501,"나경원",[98,56,75,13]);
